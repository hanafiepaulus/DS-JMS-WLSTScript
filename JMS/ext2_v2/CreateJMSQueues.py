...
cmo=create('ESBDBIsoTrnDistributedQueue','UniformDistributedQueue')

cd('/JMSSystemResources/ESBDBResources/JMSResource/ESBDBResources/UniformDistributedQueues/ESBDBIsoTrnDistributedQueue')
cmo.setJNDIName('jms.esbdb.queue.isotrn')
cmo.setSubDeploymentName('ESBDBDeployment')
